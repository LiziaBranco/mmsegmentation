...
train_dataloader = dict(
    dataset=dict(
            data_prefix=dict(
                img_path='images/split3_train', seg_map_path='masks/split3_train')))

val_dataloader = dict(
    dataset=dict(
        data_prefix=dict(
            img_path='images/split3_val', seg_map_path='masks/split3_val')))

test_dataloader_dataloader = dict(
    dataset=dict(
        data_prefix=dict(
            img_path='images/split3_test', seg_map_path='masks/split3_test')))