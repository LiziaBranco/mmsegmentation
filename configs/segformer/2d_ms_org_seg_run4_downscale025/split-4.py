...
evaluation = dict(outdir='robust_monitoring_organoid_growth/work_dirs/split-4/eval_imgs')
            
work_dir='robust_monitoring_organoid_growth/work_dirs/split-4'

train_dataloader = dict(
    dataset=dict(
            data_prefix=dict(
                img_path='images/split4_train', seg_map_path='masks/split4_train')))

val_dataloader = dict(
    dataset=dict(
        data_prefix=dict(
            img_path='images/split4_val', seg_map_path='masks/split4_val')))

test_dataloader_dataloader = dict(
    dataset=dict(
        data_prefix=dict(
            img_path='images/split4_test', seg_map_path='masks/split4_test')))